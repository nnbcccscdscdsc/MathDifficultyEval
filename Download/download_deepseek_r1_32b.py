#!/usr/bin/env python3
"""
DeepSeek-R1-Distill-Qwen-32B模型下载脚本 (安全版本 - 无删除操作)
...
def download_deepseek_r1_32b_safe():
    """
    安全下载DeepSeek-R1-Distill-Qwen-32B模型
    特点:
    - 不会删除任何现有文件
    - 支持断点续传
    - 自动检查文件完整性
    ...
    logger.info(f"📥 开始安全下载DeepSeek-R1-Distill-Qwen-32B模型: {model_name}")
    logger.info("⚠️  注意：32B模型很大，下载可能需要很长时间")
    ...
    try:
        ...
        model_cache_dir = os.path.join(cache_dir, "models--deepseek-ai--DeepSeek-R1-Distill-Qwen-32B")
